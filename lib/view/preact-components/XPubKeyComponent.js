...
var XPubKeyComponent = function (_Component) {
    _inherits(XPubKeyComponent, _Component);

    function XPubKeyComponent(props) {
        _classCallCheck(this, XPubKeyComponent);

        return _possibleConstructorReturn(this, (XPubKeyComponent.__proto__ || Object.getPrototypeOf(XPubKeyComponent)).call(this, props));
    }

    _createClass(XPubKeyComponent, [{
        key: 'keyboardHandler',
