...
var Popup = function (_AbstractContainer) {
    _inherits(Popup, _AbstractContainer);

    function Popup(channel) {
        _classCallCheck(this, Popup);

        return _possibleConstructorReturn(this, (Popup.__proto__ || Object.getPrototypeOf(Popup)).call(this, channel));
    }
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 9;
                                return _get(Popup.prototype.__proto__ || Object.getPrototypeOf(Popup.prototype), 'open', this).call(this, args).then(function (response) {
                                    resolved = true;
                                    _this2.popup.close();
                                    return response;
                                });
