...
function filterForLog(type, msg) {
    ...
    if (type in blacklist) {
        return (0, _extends3.default)({}, msg, blacklist[type]);
    } else {
        return msg;
    }
}
...
var CallHelper = exports.CallHelper = function () {
    function CallHelper(transport, sessionId, session) {
        (0, _classCallCheck3.default)(this, CallHelper);
    ...
    CallHelper.prototype.call = function call(type) {
        var _this = this;
    ...
    CallHelper.prototype.typedCall = function typedCall(type, resType) {
    ...
    CallHelper.prototype._commonCall = function _commonCall(type, msg) {
        var _this2 = this;
    ...
    CallHelper.prototype._filterCommonTypes = function _filterCommonTypes(res) {
        var _this3 = this;
    ...
    CallHelper.prototype._promptPin = function _promptPin(type) {
        var _this4 = this;
    ...
    CallHelper.prototype._promptPassphrase = function _promptPassphrase() {
        var _this5 = this;
    ...
    CallHelper.prototype._promptWord = function _promptWord() {
        var _this6 = this;
