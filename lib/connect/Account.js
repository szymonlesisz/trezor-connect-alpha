...
var _fastxpub = require('file-loader?name=fastxpub.wasm!hd-wallet/workers/fastxpub.wasm');
...
var Account = function () {
    function Account(id, node) {
        ...
        fetch(_fastxpub2.default).then(function (response) {
            response.arrayBuffer().then(function (buffer) {
                console.log("ABC", buffer);
            });
        });
        console.log(_fastxpub2.default);
        this.node = node;
        this.unspents = [];
