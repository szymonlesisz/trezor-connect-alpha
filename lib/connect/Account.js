...
var _fastxpub = require('fetch-wasm!hd-wallet/workers/fastxpub.wasm');

var _fastxpub2 = _interopRequireDefault(_fastxpub);
...
var Account = function () {
    function Account(id, node) {
        ...
        var wasm = new _fastxpub2.default();
        wasm.then(function (response) {
            response.arrayBuffer().then(function (a, b, c) {
