...
var PopupModal = function (_Popup) {
    _inherits(PopupModal, _Popup);

    function PopupModal(args) {
        _classCallCheck(this, PopupModal);

        var _this = _possibleConstructorReturn(this, (PopupModal.__proto__ || Object.getPrototypeOf(PopupModal)).call(this));
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return _get(PopupModal.prototype.__proto__ || Object.getPrototypeOf(PopupModal.prototype), 'open', this).call(this, args).then(function (response) {
                                    _this2.ui.close();
                                    return response;
                                });
