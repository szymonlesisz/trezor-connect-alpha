...
exports.POPUP_RECEIVE_PASS = exports.POPUP_REQUEST_PASS = exports.POPUP_RECEIVE_PIN = exports.POPUP_REQUEST_PIN = exports.POPUP_HANDSHAKE = exports.POPUP_LOG = undefined;
...
var POPUP_LOG = exports.POPUP_LOG = 'popup_log';
var POPUP_HANDSHAKE = exports.POPUP_HANDSHAKE = 'popup_handshake';
var POPUP_REQUEST_PIN = exports.POPUP_REQUEST_PIN = 'popup_request_pin';
var POPUP_RECEIVE_PIN = exports.POPUP_RECEIVE_PIN = 'popup_receive_pin';
var POPUP_REQUEST_PASS = exports.POPUP_REQUEST_PASS = 'popup_request_pass';
var POPUP_RECEIVE_PASS = exports.POPUP_RECEIVE_PASS = 'popup_receive_pass';

var PopupMessage = function PopupMessage(type) {
    var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    (0, _classCallCheck3.default)(this, PopupMessage);
...
var _console = __webpack_require__(303);

var _PopupMessage = __webpack_require__(101);
...
function onMessage(event) {
    ...
    switch (event.data.type) {
        case _PopupMessage.POPUP_REQUEST_PIN:
...
var initPinView = function initPinView() {
    var pin = document.getElementById("pin");
    pin.style.display = 'block';

    var input = document.getElementById('pin_input');
    var enter = document.getElementById('pin_enter');

    var buttons = pin.querySelectorAll('[data-value]');
    ...
    enter.addEventListener('click', function (event) {
        postMessage({ origin: 'null' }, new _PopupMessage2.default(_PopupMessage.POPUP_RECEIVE_PIN, input.value));
    });
};

var postMessage = function postMessage(event, message) {
...
window.addEventListener('load', function () {
    ...
    postMessage({ origin: 'null' }, new _PopupMessage2.default(_PopupMessage.POPUP_HANDSHAKE));
    (0, _console.popupConsole)(_PopupMessage.POPUP_LOG, postMessage);
}, false);
...
function popupConsole(tag, postMessage) {
    var _this = this;
    ...
    var inject = function inject(method, level) {
        return function () {
            ...
            postMessage.apply(_this, [{ origin: 'null' }, { type: tag, level: level, time: time, args: JSON.stringify(args)
...
function deepClone(obj) {
    ...
    var result = Array.isArray(obj) ? [] : obj.constructor ? new obj.constructor() : Object.create(null);
    hash.set(obj, result);
    ...
    return Object.assign.apply(Object, [result].concat(Object.keys(obj).map(function (key) {
        ...
        return _ref2 = {}, _ref2[key] = deepClone(obj[key], hash), _ref2;
    })));
}
